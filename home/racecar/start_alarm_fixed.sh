...
# Use system Python3 instead of Conda
export PATH=/usr/bin:$PATH

# Start alarm node in background
echo "Starting alarm node..."
/usr/bin/python3 install/racecar/lib/racecar/alarm_node_simple.py &
ALARM_PID=$!
...
/usr/bin/python3 install/racecar/lib/racecar/alarm_monitor.py &
MONITOR_PID=$!
